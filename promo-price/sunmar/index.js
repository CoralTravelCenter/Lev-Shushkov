...
function zeroStep() {
	...
	.benefit::after {
		content: "";
	    background: url(https://cdn.sunmar.ru/content/cms/russia/promoprices/promo-price-border.png);
		width: calc(100% + 20px);
...
<style>
	...
	const icoLayout = `<img class="promo-price-ico" src="https://cdn.sunmar.ru/content/cms/russia/promoprices/promo-price-ico.png">`;
